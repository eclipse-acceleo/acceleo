...
public class ErrorModuleReferenceImpl extends MinimalEObjectImpl.Container implements ErrorModuleReference {
	...
	protected EClass eStaticClass() {
		return AcceleoPackage.Literals.ERROR_MODULE_REFERENCE;
	}
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_MODULE_REFERENCE__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_MODULE_REFERENCE__END_POSITION, oldEndPosition, endPosition));
	}

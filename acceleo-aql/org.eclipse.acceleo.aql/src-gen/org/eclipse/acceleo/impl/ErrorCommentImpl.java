 ...
 *   <li>{@link org.eclipse.acceleo.impl.ErrorCommentImpl#isMissingEndHeader <em>Missing End Header</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ErrorCommentImpl extends MinimalEObjectImpl.Container implements ErrorComment {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_COMMENT__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcceleoPackage.ERROR_COMMENT__END_POSITION,
	...
	public NotificationChain basicSetBody(CommentBody newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_COMMENT__BODY, oldBody, newBody);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- AcceleoPackage.ERROR_COMMENT__BODY, null, msgs);
			if (newBody != null)
	...
	public void setMissingEndHeader(boolean newMissingEndHeader) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_COMMENT__MISSING_END_HEADER, oldMissingEndHeader, missingEndHeader));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcceleoPackage.ERROR_COMMENT__START_POSITION:
				return getStartPosition();
			case AcceleoPackage.ERROR_COMMENT__END_POSITION:
		...
		if (baseClass == ASTNode.class) {
			switch (baseFeatureID) {
				case AcceleoPackage.AST_NODE__START_POSITION:
					return AcceleoPackage.ERROR_COMMENT__START_POSITION;
				case AcceleoPackage.AST_NODE__END_POSITION:
					return AcceleoPackage.ERROR_COMMENT__END_POSITION;
				default:
					return -1;
			}
		}
		...
		if (baseClass == Comment.class) {
			switch (baseFeatureID) {
				case AcceleoPackage.COMMENT__BODY:
					return AcceleoPackage.ERROR_COMMENT__BODY;
				default:
					return -1;
			}
		}

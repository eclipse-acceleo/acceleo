 ...
 * <ul>
 *   <li>{@link org.eclipse.acceleo.impl.ErrorExpressionImpl#getStartPosition <em>Start Position</em>}</li>
 *   <li>{@link org.eclipse.acceleo.impl.ErrorExpressionImpl#getEndPosition <em>End Position</em>}</li>
...
public class ErrorExpressionImpl extends MinimalEObjectImpl.Container implements ErrorExpression {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_EXPRESSION__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_EXPRESSION__END_POSITION, oldEndPosition, endPosition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcceleoPackage.ERROR_EXPRESSION__START_POSITION:
				return getStartPosition();
			case AcceleoPackage.ERROR_EXPRESSION__END_POSITION:

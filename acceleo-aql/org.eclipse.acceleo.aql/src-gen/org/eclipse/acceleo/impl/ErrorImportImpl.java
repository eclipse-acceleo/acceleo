...
public class ErrorImportImpl extends MinimalEObjectImpl.Container implements ErrorImport {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcceleoPackage.ERROR_IMPORT__START_POSITION,
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcceleoPackage.ERROR_IMPORT__END_POSITION,

 ...
 *   <li>{@link org.eclipse.acceleo.impl.ErrorForStatementImpl#isMissingOpenParenthesis <em>Missing Open Parenthesis</em>}</li>
 *   <li>{@link org.eclipse.acceleo.impl.ErrorForStatementImpl#isMissingCloseParenthesis <em>Missing Close Parenthesis</em>}</li>
 *   <li>{@link org.eclipse.acceleo.impl.ErrorForStatementImpl#isMissingEndHeader <em>Missing End Header</em>}</li>
 *   <li>{@link org.eclipse.acceleo.impl.ErrorForStatementImpl#isMissingEnd <em>Missing End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ErrorForStatementImpl extends MinimalEObjectImpl.Container implements ErrorForStatement {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_FOR_STATEMENT__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.ERROR_FOR_STATEMENT__END_POSITION, oldEndPosition, endPosition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcceleoPackage.ERROR_FOR_STATEMENT__START_POSITION:
				return getStartPosition();
			case AcceleoPackage.ERROR_FOR_STATEMENT__END_POSITION:
		...
		if (baseClass == ASTNode.class) {
			switch (baseFeatureID) {
				case AcceleoPackage.AST_NODE__START_POSITION:
					return AcceleoPackage.ERROR_FOR_STATEMENT__START_POSITION;
				case AcceleoPackage.AST_NODE__END_POSITION:
					return AcceleoPackage.ERROR_FOR_STATEMENT__END_POSITION;
				default:
					return -1;
			}
		}

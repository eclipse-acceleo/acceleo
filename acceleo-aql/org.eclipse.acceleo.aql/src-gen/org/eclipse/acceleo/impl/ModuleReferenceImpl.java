...
public class ModuleReferenceImpl extends MinimalEObjectImpl.Container implements ModuleReference {
	...
	protected EClass eStaticClass() {
		return AcceleoPackage.Literals.MODULE_REFERENCE;
	}
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.MODULE_REFERENCE__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AcceleoPackage.MODULE_REFERENCE__END_POSITION, oldEndPosition, endPosition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcceleoPackage.MODULE_REFERENCE__START_POSITION:

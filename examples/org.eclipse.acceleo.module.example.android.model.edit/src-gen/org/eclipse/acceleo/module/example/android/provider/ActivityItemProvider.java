 ...
 * </copyright>
 *
 * $Id: ActivityItemProvider.java,v 1.1 2010/03/30 12:59:13 jmusset Exp $
 */
package org.eclipse.acceleo.module.example.android.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.module.example.android.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AndroidPackage.Literals.ACTIVITY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AndroidPackage.Literals.ACTIVITY__WIDGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AndroidPackage.Literals.ACTIVITY__WIDGETS,
				 WidgetsFactory.eINSTANCE.createText()));

		newChildDescriptors.add
			(createChildParameter
				(AndroidPackage.Literals.ACTIVITY__WIDGETS,
				 WidgetsFactory.eINSTANCE.createButton()));

		newChildDescriptors.add
			(createChildParameter
				(AndroidPackage.Literals.ACTIVITY__WIDGETS,
				 WidgetsFactory.eINSTANCE.createSpinner()));
	}

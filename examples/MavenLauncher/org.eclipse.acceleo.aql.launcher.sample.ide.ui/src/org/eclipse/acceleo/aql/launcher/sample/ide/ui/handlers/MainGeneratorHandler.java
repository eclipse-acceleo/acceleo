...
package org.eclipse.acceleo.aql.launcher.sample.ide.ui.handlers;
...
import org.eclipse.acceleo.aql.launcher.sample.ide.ui.Activator;
import org.eclipse.acceleo.aql.launcher.sample.ide.ui.MainGeneratorEclipse;
...
/**
 * Command handler for org::eclipse::acceleo::aql::launcher::sample::main.
 * 
				...
				for (Object selected : selectedList) {
					...
					try {
						if (selected instanceof EClass) {
							generator = new MainGeneratorEclipse((EClass) selected);

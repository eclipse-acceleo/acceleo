...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Restart</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.acceleo.textualgame.impl.RestartImpl#isIsOneTime <em>Is One Time</em>}</li>
 * <li>{@link org.eclipse.acceleo.textualgame.impl.RestartImpl#getIsVisible <em>Is Visible</em>}</li>
 * <li>{@link org.eclipse.acceleo.textualgame.impl.RestartImpl#getIsEnabled <em>Is Enabled</em>}</li>
 * <li>{@link org.eclipse.acceleo.textualgame.impl.RestartImpl#isIsOnEnter <em>Is On Enter</em>}</li>
 * <li>{@link org.eclipse.acceleo.textualgame.impl.RestartImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RestartImpl extends MinimalEObjectImpl.Container implements Restart {
	...
	protected EClass eStaticClass() {
		return TextualgamePackage.Literals.RESTART;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, TextualgamePackage.RESTART__NAME, oldName,
					name));
		}
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, TextualgamePackage.RESTART__DESCRIPTION,
	...
	public void setIsOneTime(boolean newIsOneTime) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, TextualgamePackage.RESTART__IS_ONE_TIME,
	...
	public NotificationChain basicSetIsVisible(Condition newIsVisible, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TextualgamePackage.RESTART__IS_VISIBLE, oldIsVisible, newIsVisible);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newIsVisible != isVisible) {
			...
			if (isVisible != null) {
				msgs = ((InternalEObject)isVisible).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- TextualgamePackage.RESTART__IS_VISIBLE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TextualgamePackage.RESTART__IS_VISIBLE,
	...
	public NotificationChain basicSetIsEnabled(Condition newIsEnabled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TextualgamePackage.RESTART__IS_ENABLED, oldIsEnabled, newIsEnabled);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newIsEnabled != isEnabled) {
			...
			if (isEnabled != null) {
				msgs = ((InternalEObject)isEnabled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- TextualgamePackage.RESTART__IS_ENABLED, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TextualgamePackage.RESTART__IS_ENABLED,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextualgamePackage.RESTART__IS_VISIBLE:
				return basicSetIsVisible(null, msgs);
			case TextualgamePackage.RESTART__IS_ENABLED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TextualgamePackage.RESTART__NAME:
				return getName();
			case TextualgamePackage.RESTART__DESCRIPTION:
				return getDescription();
			case TextualgamePackage.RESTART__IS_ONE_TIME:
				return isIsOneTime();
			case TextualgamePackage.RESTART__IS_VISIBLE:
				return getIsVisible();
			case TextualgamePackage.RESTART__IS_ENABLED:
		...
		if (baseClass == ConditionalElement.class) {
			switch (baseFeatureID) {
				case TextualgamePackage.CONDITIONAL_ELEMENT__IS_ONE_TIME:
					return TextualgamePackage.RESTART__IS_ONE_TIME;
				case TextualgamePackage.CONDITIONAL_ELEMENT__IS_VISIBLE:
					return TextualgamePackage.RESTART__IS_VISIBLE;
				case TextualgamePackage.CONDITIONAL_ELEMENT__IS_ENABLED:
					return TextualgamePackage.RESTART__IS_ENABLED;
				default:
					return -1;
			}
		}

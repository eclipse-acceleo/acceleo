 ...
 * </copyright>
 *
 * $Id: ButtonImpl.java,v 1.1 2010/03/30 12:57:37 jmusset Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.acceleo.module.example.android.widgets.impl.ButtonImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ButtonImpl extends EObjectImpl implements Button {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WidgetsPackage.BUTTON__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WidgetsPackage.BUTTON__NAME:
				return getName();
		}

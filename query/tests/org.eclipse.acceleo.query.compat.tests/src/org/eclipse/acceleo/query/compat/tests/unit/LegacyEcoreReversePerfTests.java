...
import org.eclipse.acceleo.query.tests.unit.EcoreReversePerfTests;

public class LegacyEcoreReversePerfTests extends EcoreReversePerfTests {

	public LegacyEcoreReversePerfTests(QueryEvaluationResultExpectation expect, String name) {
		super(expect, name);
	}

...
import org.eclipse.acceleo.query.tests.unit.AnyDSLEvaluationPerfTests;

public class LegacyAnyDSLEvaluationPerfTests extends AnyDSLEvaluationPerfTests {

	public LegacyAnyDSLEvaluationPerfTests(QueryEvaluationResultExpectation expect, String name) {
		super(expect, name);
	}

...
/**
 * This is the action bar contributor for the Anydsl model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class AnydslActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(AnydslEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(AnydslEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	public AnydslActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("anydsl-settings"));
		toolBarManager.add(new Separator("anydsl-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(AnydslEditorPlugin.INSTANCE
				.getString("_UI_AnydslEditor_menu"), "org.eclipse.acceleo.query.tests.anydslMenuID");
		...
		//
		createChildMenuManager = new MenuManager(AnydslEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(AnydslEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(AnydslEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(AnydslEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

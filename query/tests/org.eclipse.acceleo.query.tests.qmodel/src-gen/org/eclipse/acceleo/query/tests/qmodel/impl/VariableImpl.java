 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.query.tests.qmodel.impl.VariableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VariableImpl extends MinimalEObjectImpl.Container implements Variable {
	...
	protected EClass eStaticClass() {
		return QmodelPackage.Literals.VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmodelPackage.VARIABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QmodelPackage.VARIABLE__NAME:
				return getName();
		}

...
public class AnyDSLEvaluationPerfTests extends TestEvaluationPerfQModel {

	public AnyDSLEvaluationPerfTests(QueryEvaluationResultExpectation expect, String name) {
		super(expect, name);
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link container.impl.ContainerImpl#getContained <em>Contained</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements container.Container {
	 ...
	 * @ordered
	 */
	protected EList<Contained> contained;
	 ...
	 */
	@Override
	public EList<Contained> getContained() {
		if (contained == null) {
			contained = new EObjectContainmentEList<Contained>(Contained.class, this, ContainerPackage.CONTAINER__CONTAINED);
		}
		return contained;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ContainerPackage.CONTAINER__CONTAINED:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ContainerPackage.CONTAINER__CONTAINED:
				getContained().clear();
				getContained().addAll((Collection<? extends Contained>)newValue);
				return;
		}

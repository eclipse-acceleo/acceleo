...
public class RealFactoryImpl extends EFactoryImpl implements RealFactory {
	...
	public static RealFactory init() {
		try {
			RealFactory theRealFactory = (RealFactory)EPackage.Registry.INSTANCE.getEFactory(RealPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RealPackage.KEYWORD: return createKeyword();
			default:
	 ...
	 * @generated
	 */
	public Real.String createStringFromString(EDataType eDataType, String initialValue) {
		Real.String result = Real.String.get(initialValue);

...
/**
 * This is the action bar contributor for the Qmodel model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class QmodelActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(QmodelEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(QmodelEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	public QmodelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("qmodel-settings"));
		toolBarManager.add(new Separator("qmodel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(QmodelEditorPlugin.INSTANCE
				.getString("_UI_QmodelEditor_menu"), "org.eclipse.acceleo.query.tests.qmodelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(QmodelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(QmodelEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(QmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(QmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

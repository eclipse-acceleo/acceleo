...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.query.tests.anydsl.Animal} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AnimalItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addPartPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Animal_part_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Animal_part_feature",
								"_UI_Animal_type"), AnydslPackage.Literals.ANIMAL__PART, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns Animal.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		List<String> labelValue = ((Animal)object).getName();
		...
		return label == null || label.length() == 0 ? getString("_UI_Animal_type")
				: getString("_UI_Animal_type") + " " + label.toString();
	}

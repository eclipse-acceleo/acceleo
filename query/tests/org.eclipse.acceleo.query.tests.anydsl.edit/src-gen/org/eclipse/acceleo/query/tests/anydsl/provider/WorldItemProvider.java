...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.query.tests.anydsl.World} object. <!--
...
public class WorldItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnydslPackage.Literals.WORLD__COMPANIES);
			childrenFeatures.add(AnydslPackage.Literals.WORLD__FOODS);
			childrenFeatures.add(AnydslPackage.Literals.WORLD__SOURCES);
		}
	...
	/**
	 * This returns World.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AnydslPackage.Literals.WORLD__COMPANIES,
				AnydslFactory.eINSTANCE.createProductionCompany()));

		newChildDescriptors.add(createChildParameter(AnydslPackage.Literals.WORLD__COMPANIES,
				AnydslFactory.eINSTANCE.createRestaurant()));

		newChildDescriptors.add(createChildParameter(AnydslPackage.Literals.WORLD__FOODS,
				AnydslFactory.eINSTANCE.createFood()));

		newChildDescriptors.add(createChildParameter(AnydslPackage.Literals.WORLD__SOURCES,
				AnydslFactory.eINSTANCE.createPlant()));

		newChildDescriptors.add(createChildParameter(AnydslPackage.Literals.WORLD__SOURCES,
				AnydslFactory.eINSTANCE.createAnimal()));
	}

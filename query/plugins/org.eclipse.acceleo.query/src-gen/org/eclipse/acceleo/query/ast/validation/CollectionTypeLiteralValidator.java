...
/**
 * A sample validator interface for {@link org.eclipse.acceleo.query.ast.CollectionTypeLiteral}. This doesn't
 ...
 */
public interface CollectionTypeLiteralValidator {
	boolean validate();

	boolean validateElementType(TypeLiteral value);
}

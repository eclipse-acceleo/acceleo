...
AQL can also call methods modeled as EOperations or defined through Java services. The syntax denoting such a call is @(..)@. @self.someCall()@ will call the *someCall* method and return the result.

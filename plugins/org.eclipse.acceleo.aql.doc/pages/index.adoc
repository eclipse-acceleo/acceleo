...
The migration tool doesn't cover all migration cases and you will need to manually fix remaining problems. The tool will migrate modules and services Java classes. If will also copy other resources. If you have generated Java launcher and/or Eclipse UI plug-in launcher, you will need to <<java-launchers,generate>> them from Acceleo 4.

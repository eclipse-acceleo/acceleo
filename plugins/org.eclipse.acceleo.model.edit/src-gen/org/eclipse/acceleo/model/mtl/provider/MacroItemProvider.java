...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.model.mtl.Macro} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MacroItemProvider extends BlockItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Macro_type_feature", "_UI_Macro_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				MtlPackage.Literals.MACRO__TYPE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MtlPackage.Literals.MACRO__PARAMETER);
		}
	...
	/**
	 * This returns Macro.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Macro_type") : //$NON-NLS-1$
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MtlPackage.Literals.MACRO__PARAMETER,

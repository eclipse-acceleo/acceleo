...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.model.mtl.InitSection} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class InitSectionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public InitSectionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MtlPackage.Literals.INIT_SECTION__VARIABLE);
		}
	...
	/**
	 * This returns InitSection.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InitSection")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		InitSection initSection = (InitSection)object;
		return getString("_UI_InitSection_type") + " " + initSection.getStartPosition(); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InitSection.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MtlPackage.Literals.INIT_SECTION__VARIABLE,

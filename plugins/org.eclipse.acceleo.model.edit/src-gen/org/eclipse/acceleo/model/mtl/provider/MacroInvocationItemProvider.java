...
/**
 * This is the item provider adapter for a {@link org.eclipse.acceleo.model.mtl.MacroInvocation} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MacroInvocationItemProvider extends TemplateExpressionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public MacroInvocationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
						...
						getResourceLocator(),
						getString("_UI_MacroInvocation_definition_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MacroInvocation_definition_feature", "_UI_MacroInvocation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						MtlPackage.Literals.MACRO_INVOCATION__DEFINITION, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MtlPackage.Literals.MACRO_INVOCATION__ARGUMENT);
		}
	...
	/**
	 * This returns MacroInvocation.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MacroInvocation")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((MacroInvocation)object).getName();
		return label == null || label.length() == 0 ? getString("_UI_MacroInvocation_type") : //$NON-NLS-1$
				getString("_UI_MacroInvocation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MacroInvocation.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MtlPackage.Literals.MACRO_INVOCATION__ARGUMENT,

 ...
 *******************************************************************************/
package org.eclipse.acceleo.internal.compatibility;
...
/**
 * Utility class to access externalized Strings for Acceleo's compatibility Plug-in.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public final class AcceleoCompatibilityMessages {
	/** Full qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.acceleo.internal.compatibility.acceleocompatibilitymessages"; //$NON-NLS-1$
	 ...
	 */
	private AcceleoCompatibilityMessages() {

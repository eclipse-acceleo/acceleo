 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.expressions.impl.NotImpl#getExpression <em>Expression
 * </em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class NotImpl extends ASTNodeImpl implements Not {
	/**
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.NOT__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- ExpressionsPackage.NOT__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.NOT__EXPRESSION,

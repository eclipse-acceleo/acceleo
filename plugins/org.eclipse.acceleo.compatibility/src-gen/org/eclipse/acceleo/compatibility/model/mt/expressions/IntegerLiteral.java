 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.expressions.IntegerLiteral#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.acceleo.compatibility.model.mt.expressions.ExpressionsPackage#getIntegerLiteral()
 * @model
 * @generated
 */
public interface IntegerLiteral extends Literal {
	 ...
	 * @see #setValue(int)
	 * @see org.eclipse.acceleo.compatibility.model.mt.expressions.ExpressionsPackage#getIntegerLiteral_Value()
	 * @model required="true"
	 * @generated
	 */
	int getValue();

 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.statements.impl.CommentImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class CommentImpl extends ASTNodeImpl implements Comment {
	/**
	...
	protected EClass eStaticClass() {
		return StatementsPackage.Literals.COMMENT;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.COMMENT__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatementsPackage.COMMENT__VALUE:
				return getValue();
		}

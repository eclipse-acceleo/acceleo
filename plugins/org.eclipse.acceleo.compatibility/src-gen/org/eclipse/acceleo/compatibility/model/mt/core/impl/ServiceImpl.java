 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.core.impl.ServiceImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.core.impl.ServiceImpl#getMethods <em>Methods</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ServiceImpl extends EObjectImpl implements Service {
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<Method>(Method.class, this, CorePackage.SERVICE__METHODS);
		}
		return methods;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.SERVICE__METHODS:

 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.expressions.impl.ParenthesisImpl#getExpression <em>
 * Expression</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class ParenthesisImpl extends ASTNodeImpl implements Parenthesis {
	/**
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.PARENTHESIS__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- ExpressionsPackage.PARENTHESIS__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.PARENTHESIS__EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExpressionsPackage.PARENTHESIS__EXPRESSION:

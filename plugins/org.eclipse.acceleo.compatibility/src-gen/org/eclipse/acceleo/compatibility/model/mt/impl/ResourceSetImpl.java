 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.impl.ResourceSetImpl#getResources <em>Resources</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class ResourceSetImpl extends EObjectImpl implements ResourceSet {
	...
	protected EClass eStaticClass() {
		return MtPackage.Literals.RESOURCE_SET;
	}
	...
	public EList<Resource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<Resource>(Resource.class, this,
					MtPackage.RESOURCE_SET__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MtPackage.RESOURCE_SET__RESOURCES:

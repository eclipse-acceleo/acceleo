 ...
 * <ul>
 * <li>{@link org.eclipse.acceleo.compatibility.model.mt.statements.impl.FeatureImpl#getExpression <em>
 * Expression </em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class FeatureImpl extends ASTNodeImpl implements Feature {
	/**
	...
	protected EClass eStaticClass() {
		return StatementsPackage.Literals.FEATURE;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatementsPackage.FEATURE__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- StatementsPackage.FEATURE__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.FEATURE__EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatementsPackage.FEATURE__EXPRESSION:

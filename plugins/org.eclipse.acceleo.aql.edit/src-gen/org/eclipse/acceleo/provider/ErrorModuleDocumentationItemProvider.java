...
public class ErrorModuleDocumentationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMissingEndHeaderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ErrorModuleDocumentation_missingEndHeader_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_ErrorModuleDocumentation_missingEndHeader_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ErrorModuleDocumentation_type"), //$NON-NLS-1$
				AcceleoPackage.Literals.ERROR_MODULE_DOCUMENTATION__MISSING_END_HEADER, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ErrorModuleDocumentation")); //$NON-NLS-1$
	}

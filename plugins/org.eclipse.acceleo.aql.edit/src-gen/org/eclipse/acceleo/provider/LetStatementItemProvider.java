...
public class LetStatementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LetStatement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		LetStatement letStatement = (LetStatement) object;
		return getString("_UI_LetStatement_type") + " " + letStatement.isMultiLines(); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LetStatement.class)) {

 ...
 * the sub-expressions part of said view.
 * 
...
public class ToggleStepByStepVisibilityAction extends Action {
	...
	private static final String TOOLTIP_TEXT = InterpreterMessages
			.getString("intepreter.action.showstepbystep.tooltip"); //$NON-NLS-1$
	...
	public ToggleStepByStepVisibilityAction(InterpreterView view) {
		...
		setImageDescriptor(InterpreterImages
				.getImageDescriptor(IInterpreterConstants.STEP_BY_STEP_VISIBILITY_TOGGLE_ICON));
		this.view = view;
	}

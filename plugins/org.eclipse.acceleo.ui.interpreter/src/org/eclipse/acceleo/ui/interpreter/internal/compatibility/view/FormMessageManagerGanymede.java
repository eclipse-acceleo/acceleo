...
public class FormMessageManagerGanymede implements IFormMessageManager {
	/**
	 * These will be used as the summary when multiple messages are to be added to the form. This is specific
	 * to galileo.
	 */
	private static final String[] MULTIPLE_MESSAGE_SUMMARY_KEYS = new String[] {
	...
	private synchronized void updateMessages() {
		if (messages.isEmpty()) {
			...
			final String summary = InterpreterMessages.getString(MULTIPLE_MESSAGE_SUMMARY_KEYS[type],
					messages.size());

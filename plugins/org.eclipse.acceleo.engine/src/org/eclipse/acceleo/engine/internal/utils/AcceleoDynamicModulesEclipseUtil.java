 ...
 */
public final class AcceleoDynamicModulesEclipseUtil {
	...
	private static final Set<DynamicModuleContribution> REGISTERED_MODULES_CONTRIBUTION = new CompactLinkedHashSet<DynamicModuleContribution>();

	/**
	 * Utility classes don't need a default constructor.
	 */
	private AcceleoDynamicModulesEclipseUtil() {
		// hides constructor
	}
	...
	public static void clearRegistry() {
		...
		REGISTERED_MODULES_CONTRIBUTION.clear();
	}
	 ...
	 */
	public static CompactLinkedHashSet<DynamicModuleContribution> getRegisteredModules() {
		refreshModules();
		return new CompactLinkedHashSet<DynamicModuleContribution>(REGISTERED_MODULES_CONTRIBUTION);
	}
		...
		for (java.util.Map.Entry<Bundle, AcceleoDynamicModulesDescriptor> entry : new CompactLinkedHashSet<java.util.Map.Entry<Bundle, AcceleoDynamicModulesDescriptor>>(
			...
			for (String path : descriptor.getPaths()) {
				...
				try {
					...
					REGISTERED_MODULES_CONTRIBUTION.add(new DynamicModuleContribution(descriptor
							.getGeneratorIDs(), modules));
				} catch (IOException e) {

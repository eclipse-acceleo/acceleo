 ...
 * </copyright>
 *
 * $Id: TraceabilityFactory.java,v 1.2 2010/04/26 15:24:14 lgoubet Exp $
 */
...
public interface TraceabilityFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Model File</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Module File</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Generated File</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Input Element</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Module Element</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Generated Text</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 

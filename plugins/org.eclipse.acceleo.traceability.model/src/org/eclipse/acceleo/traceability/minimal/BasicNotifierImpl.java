 ...
 * </copyright>
 *
 * $Id: BasicNotifierImpl.java,v 1.1 2011/03/08 13:55:40 sbegaudeau Exp $
 */
...
public class BasicNotifierImpl implements Notifier {
	...
	/**
	 * An interface implemented by {@link BasicNotifierImpl#eAdapters() adapter lists} that allows
	 * {@link BasicNotifierImpl.EObservableAdapterList.Listener listeners} to observe {@link Adapter adapters}
	...
	public interface EObservableAdapterList {
		/**
		 * An interface implemented by clients wishing to observe {@link Adapter adapters} being added and
		 * removed from an {@link BasicNotifierImpl#eAdapters() adapter lists}.
		 * 
		 * @since 2.6
		 */
		interface Listener {
			 ...
			 * 
			 * @param notifier
			 *            the notifier being adapted.
			 * @param adapter
			 *            the adapter being added to the notifier.
			 */
			 ...
			 * 
			 * @param notifier
			 *            the notifier that was being adapted.
			 * @param adapter
			 *            the adapter being removed from the notifier.
			 */
	...
	public static class EAdapterList<E extends Object & Adapter> extends BasicEList<E> implements EObservableAdapterList {
		...
		protected void didRemove(int index, E oldObject) {
			...
			if (notifier.eDeliver()) {
				Notification notification = new NotificationImpl(Notification.REMOVING_ADAPTER, oldObject,
						null, index) {
					@Override
	...
	/**
	 * Returns the underlying array of adapters. The length of this array reflects exactly the number of
	 * adapters where <code>null</code> represents the lack of any adapters. This array may not be modified by
	 * the caller and must be guaranteed not to be modified even if the {@link #eAdapters() list of adapters}
	 * is modified.
	 * 
	...
	/**
	 * Returns whether {@link #eNotify eNotify} needs to be called. This may return <code>true</code> even
	 * when {@link #eDeliver eDeliver} is <code>false</code> or when {@link #eAdapters eAdapters} is empty.
	 * 

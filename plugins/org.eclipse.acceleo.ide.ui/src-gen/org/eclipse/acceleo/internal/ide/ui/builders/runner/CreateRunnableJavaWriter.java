...
public class CreateRunnableJavaWriter
{
  ...
  protected final String TEXT_17 = NL + "\t\t// TODO If you need additional package registrations, do them here. The following line is an example for UML." + NL + "\t\t// resourceSet.getPackageRegistry().put(UMLPackage.eNS_URI, UMLPackage.eINSTANCE);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This can be used to update the resource set's resource factory registry with all needed factories." + NL + "\t * " + NL + "\t * @param resourceSet" + NL + "\t *            The resource set which registry has to be updated." + NL + "\t * @generated" + NL + "\t */" + NL + "\t@Override" + NL + "\tpublic void registerResourceFactories(ResourceSet resourceSet) {" + NL + "\t\tsuper.registerResourceFactories(resourceSet);" + NL + "\t\t// TODO If you need additional resource factories registrations, do them here. The following line is an example for UML." + NL + "\t\t// resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(UMLResource.FILE_EXTENSION, UMLResource.Factory.INSTANCE);" + NL + "\t}" + NL + "\t" + NL + "}";

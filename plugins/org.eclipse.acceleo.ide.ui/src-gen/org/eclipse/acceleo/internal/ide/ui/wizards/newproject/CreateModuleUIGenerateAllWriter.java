...
public class CreateModuleUIGenerateAllWriter
{
  ...
  protected final String TEXT_2 = ".common;" + NL + "" + NL + "import java.io.File;" + NL + "import java.io.IOException;" + NL + "import java.net.URL;" + NL + "import java.util.Enumeration;" + NL + "import java.util.List;" + NL + "" + NL + "import org.eclipse.acceleo.engine.AcceleoProgressMonitor;" + NL + "import org.eclipse.core.runtime.IPath;" + NL + "import org.eclipse.core.runtime.IProgressMonitor;" + NL + "import org.eclipse.core.runtime.Path;" + NL + "import org.eclipse.core.runtime.Platform;" + NL + "import org.eclipse.emf.common.util.URI;";
  ...
  protected final String TEXT_10 = "(modelURI, targetFolder, arguments) {" + NL + "\t\t\tprotected URI createTemplateURI(String entry) {" + NL + "\t\t\t\treturn template0;" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t\tgen0.doGenerate(new AcceleoProgressMonitor(monitor));" + NL + "\t\t\t";
  ...
  protected final String TEXT_20 = ".doGenerate(new AcceleoProgressMonitor(monitor));";

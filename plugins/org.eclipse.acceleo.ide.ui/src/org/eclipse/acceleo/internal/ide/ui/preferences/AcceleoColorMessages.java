 ...
 */
public final class AcceleoColorMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.acceleo.internal.ide.ui.preferences.acceleocolormessages"; //$NON-NLS-1$

...
/**
 * This action will hide all the queries from the outline view.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 */
public class HideQueriesAction extends Action {
	 ...
	 */
	public HideQueriesAction(TreeViewer treeViewer) {
		super(AcceleoUIMessages.getString("AcceleoEditorOutline.Actions.HideQueries"), SWT.TOGGLE); //$NON-NLS-1$
	...
	public ImageDescriptor getImageDescriptor() {
		return AcceleoUIActivator.getImageDescriptor("icons/template-editor/outline/HideQueries.gif"); //$NON-NLS-1$
	}
	...
	public String getToolTipText() {
		return AcceleoUIMessages.getString("AcceleoEditorOutline.Actions.HideQueries"); //$NON-NLS-1$
	}

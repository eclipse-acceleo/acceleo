...
/**
 * A module project handler for the Overrides view. The goal of this class is to handle a workspace project or
 * a bundle project.
 * 
...
public class ModuleProjectHandler {
	 ...
	 *            editor
	 */
	public ModuleProjectHandler(String name, Module[] modules, boolean resolved) {
		this.name = name;

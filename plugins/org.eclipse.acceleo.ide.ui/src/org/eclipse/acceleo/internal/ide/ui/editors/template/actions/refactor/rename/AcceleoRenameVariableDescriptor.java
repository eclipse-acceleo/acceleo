 ...
 */
public class AcceleoRenameVariableDescriptor extends RefactoringDescriptor {

	/**
	 * Refactoring ID.
	 */
	public static final String REFACTORING_ID = "org.eclipse.acceleo.ide.ui.refactor.renamevariable"; //$NON-NLS-1$
	 ...
	 *            The arguments.
	 */
	protected AcceleoRenameVariableDescriptor(final String project, final String description,

 ...
 */
public class AcceleoRenameModuleRefactoringContribution extends RefactoringContribution {
	...
	public RefactoringDescriptor createDescriptor(final String id, final String project,
		...
		return new AcceleoRenameModuleDescriptor(project, description, comment, arguments);
	}
	...
	public Map retrieveArgumentMap(final RefactoringDescriptor descriptor) {
		if (descriptor instanceof AcceleoRenameModuleDescriptor) {
			return ((AcceleoRenameModuleDescriptor)descriptor).getArguments();
		}

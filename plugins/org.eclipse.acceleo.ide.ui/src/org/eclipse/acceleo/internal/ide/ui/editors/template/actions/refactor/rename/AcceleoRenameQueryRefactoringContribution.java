 ...
 */
public class AcceleoRenameQueryRefactoringContribution extends RefactoringContribution {
	...
	public RefactoringDescriptor createDescriptor(final String id, final String project,
		...
		return new AcceleoRenameQueryDescriptor(project, description, comment, arguments);
	}
	...
	public Map retrieveArgumentMap(final RefactoringDescriptor descriptor) {
		if (descriptor instanceof AcceleoRenameQueryDescriptor) {
			return ((AcceleoRenameQueryDescriptor)descriptor).getArguments();
		}

...
public class AcceleoIfScanner extends AbstractAcceleoScanner {
	 ...
	 */
	public AcceleoIfScanner(IEclipsePreferences[] lookupOrder) {
		super(lookupOrder);
	}
	...
	private IRule computeKeywordRule(String precedingDelimiter, String keyword, String followingDelimiter) {
		return new KeywordSequenceRule(precedingDelimiter, keyword, followingDelimiter, createToken(
				AcceleoColor.IF, null, SWT.ITALIC | SWT.BOLD));
	}
	...
	private IRule computeDelimiterRule(String precedingText, String delimiter, String followingText) {
		return new KeywordSequenceRule(precedingText, delimiter, followingText, createToken(AcceleoColor.IF,
				null, SWT.BOLD));
	}

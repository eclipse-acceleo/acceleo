...
/**
 * Quick fix resolution on the Acceleo problem marker. To create a new template before the next member with
...
public class AcceleoCreateTemplateResolutionBeforeNextMember extends AbstractCreateModuleElementResolution {
	...
	public String getDescription() {
		return AcceleoUIMessages.getString("AcceleoCreateTemplateResolutionBeforeNextMember.Description"); //$NON-NLS-1$
	}
	...
	public String getLabel() {
		return AcceleoUIMessages.getString("AcceleoCreateTemplateResolutionBeforeNextMember.Label"); //$NON-NLS-1$
	}

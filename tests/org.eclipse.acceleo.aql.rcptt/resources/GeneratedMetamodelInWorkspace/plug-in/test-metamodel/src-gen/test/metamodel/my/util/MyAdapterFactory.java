/**
 */
package test.metamodel.my.util;
 ...
 * <!-- end-user-doc -->
 * @see test.metamodel.my.MyPackage
 * @generated
 */
public class MyAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link test.metamodel.my.Root <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see test.metamodel.my.Root
	 * @generated
	 */

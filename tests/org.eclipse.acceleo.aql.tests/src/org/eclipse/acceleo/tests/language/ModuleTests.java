 ...
 */
public class ModuleTests extends AbstractLanguageTestSuite {
	 ...
	 */
	public ModuleTests(String testFolder) throws IOException {
		super(testFolder);
	}
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/language/module");
	}

...
/**
 * Tests {@link org.eclipse.acceleo.ProtectedArea ProtectedArea}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class ProtectedAreaTests extends AbstractLanguageTestSuite {
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/language/protectedArea");
	}

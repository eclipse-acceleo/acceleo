...
/**
 * Tests {@link org.eclipse.acceleo.BlockComment BlockComment}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class BlockCommentTests extends AbstractLanguageTestSuite {
	 ...
	 */
	public BlockCommentTests(String testFolder) throws IOException {
		super(testFolder);
	}
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/language/blockComment");
	}

 ...
 */
public class IfStatementFalseTests extends AbstractEvaluationTestSuite {
	 ...
	 */
	public IfStatementFalseTests(String testFolder) throws IOException {
		super(testFolder);
	}
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/evaluation/indentation/ifStatementFalse");
	}

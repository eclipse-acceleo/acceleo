...
/**
 * Tests {@link org.eclipse.acceleo.LetStatement LetStatement}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class LetStatementTests extends AbstractEvaluationTestSuite {
	 ...
	 */
	public LetStatementTests(String testFolder) throws IOException {
		super(testFolder);
	}
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/evaluation/indentation/letStatement");
	}

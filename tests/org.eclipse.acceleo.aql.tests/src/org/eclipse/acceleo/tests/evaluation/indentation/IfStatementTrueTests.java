 ...
 */
public class IfStatementTrueTests extends AbstractEvaluationTestSuite {
	 ...
	 */
	public IfStatementTrueTests(String testFolder) throws IOException {
		super(testFolder);
	}
	...
	public static Collection<Object[]> retrieveTestFolders() {
		return retrieveTestFolders("resources/evaluation/indentation/ifStatementTrue");
	}

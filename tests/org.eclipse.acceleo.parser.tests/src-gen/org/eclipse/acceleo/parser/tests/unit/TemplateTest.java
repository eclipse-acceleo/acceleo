...
public class TemplateTest extends AbstractCstTest {
	...
	public void testOverrides() {
		EStructuralFeature feature = org.eclipse.acceleo.parser.cst.CstPackage.eINSTANCE.getTemplate_Overrides();
		Template template = CstFactory.eINSTANCE.createTemplate();
		template.eAdapters().add(new MockEAdapter());
		org.eclipse.acceleo.parser.cst.TemplateOverridesValue overridesValue = org.eclipse.acceleo.parser.cst.CstFactory.eINSTANCE.createTemplateOverridesValue();
		List<org.eclipse.acceleo.parser.cst.TemplateOverridesValue> listOverrides = new ArrayList<org.eclipse.acceleo.parser.cst.TemplateOverridesValue>(1);
	...
	public void testParameter() {
		EStructuralFeature feature = org.eclipse.acceleo.parser.cst.CstPackage.eINSTANCE.getTemplate_Parameter();
		Template template = CstFactory.eINSTANCE.createTemplate();
		template.eAdapters().add(new MockEAdapter());

...
public class QueryTest extends AbstractCstTest {
	...
	public void testExpression() {
		EStructuralFeature feature = org.eclipse.acceleo.parser.cst.CstPackage.eINSTANCE.getQuery_Expression();
		Query query = CstFactory.eINSTANCE.createQuery();
		query.eAdapters().add(new MockEAdapter());
		org.eclipse.acceleo.parser.cst.ModelExpression expressionValue = org.eclipse.acceleo.parser.cst.CstFactory.eINSTANCE.createModelExpression();

...
public class AcceleoServiceTest extends AbstractAcceleoTest {
	...
	public void testDoGenerateModuleMapNoPreview() throws IOException {
		...
		final Map<String, Writer> preview = new AcceleoService().doGenerate(templates, inputModel,
	...
	public void testDoGenerateModuleMapNoPreviewNoGenerationRoot() {
		try {
			new AcceleoService().doGenerate(getTemplateMap(), inputModel, null, false, new BasicMonitor());
	...
	public void testDoGenerateModuleMapNullInput() {
		try {
			new AcceleoService().doGenerate(getTemplateMap(), null, null, true, new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
		}
	...
	public void testDoGenerateModuleMapNullMap() {
		try {
			new AcceleoService().doGenerate((Map<Module, Set<String>>)null, inputModel, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
	...
	public void testDoGenerateModuleMapPreview() {
		final Map<Module, Set<String>> templates = getTemplateMap();
		final Map<String, Writer> preview = new AcceleoService().doGenerate(templates, inputModel, null,
				true, null);
	...
	public void testDoGenerateModuleMapUnmatchedTemplate() {
		try {
			...
			new AcceleoService().doGenerate(templates, inputModel, null, true, new BasicMonitor());
	...
	public void testDoGenerateModuleNoPreview() throws IOException {
		...
		final Map<String, Writer> preview = new AcceleoService().doGenerate(module1, "template_1_1",
				inputModel, arguments, generationRoot, false, null);
		assertTrue("The preview should be empty", preview.isEmpty());
	...
	public void testDoGenerateModuleNoPreviewNoGenerationRoot() {
		try {
			new AcceleoService().doGenerate(module1, "template_1_1", inputModel, arguments, null, false,
					new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
	...
	public void testDoGenerateModuleNullInput() {
		try {
			new AcceleoService().doGenerate(module1, "template_1_1", null, arguments, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
	...
	public void testDoGenerateModuleNullModule() {
		try {
			new AcceleoService().doGenerate((Module)null, "template_1_1", inputModel, arguments, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
	...
	public void testDoGenerateModulePreview() {
		final Map<String, Writer> preview = new AcceleoService().doGenerate(module1, "template_1_1",
				inputModel, arguments, null, true, null);
		assertNotNull("A preview should have been generated by the service", preview);
		assertFalse("The preview shouldn't be empty", preview.isEmpty());
	...
	public void testDoGenerateModulePreviewContainedTarget() {
		final Map<String, Writer> preview = new AcceleoService().doGenerate(module1, "template_1_2",
				inputModel, arguments, null, true, null);
		assertNotNull("A preview should have been generated by the service", preview);
		assertFalse("The preview shouldn't be empty", preview.isEmpty());
	...
	public void testDoGenerateModulePrivateTemplate() {
		try {
			new AcceleoService().doGenerate(module1, "template_1_3", inputModel, arguments, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_AEE);
		} catch (AcceleoEvaluationException e) {
			// expected behavior
	...
	public void testDoGenerateModuleUnmatchedTemplate() {
		try {
			new AcceleoService().doGenerate(module1, "unmatched_name", inputModel, arguments, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_AEE);
		} catch (AcceleoEvaluationException e) {
			// expected behavior
	...
	public void testDoGenerateTemplateModuleUnmatchedTemplate() {
		try {
			arguments.add("test");
			arguments.add("test");
			new AcceleoService().doGenerateTemplate(module2, "template_2_2", arguments, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_AEE);
		} catch (AcceleoEvaluationException e) {
			// expected behavior
	...
	public void testDoGenerateTemplateMultipleArguments() {
		try {
			new AcceleoService().doGenerate(multipleArgumentTemplate, inputModel, null, true,
					new BasicMonitor());
			fail(FAIL_EXPECTED_AEE);
		} catch (AcceleoEvaluationException e) {
			// expected behavior
	...
	public void testDoGenerateTemplateNoPreview() throws IOException {
		...
		final Map<String, Writer> preview = new AcceleoService().doGenerate(publicTemplate, inputModel,
				generationRoot, false, null);
		assertTrue("The preview should be empty", preview.isEmpty());
	...
	public void testDoGenerateTemplateNoPreviewNoGenerationRoot() {
		try {
			new AcceleoService().doGenerate(publicTemplate, inputModel, null, false, new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
		}
	...
	public void testDoGenerateTemplateNullInput() {
		try {
			new AcceleoService().doGenerate(publicTemplate, null, null, true, new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
		}
	...
	public void testDoGenerateTemplateNullTemplate() {
		try {
			new AcceleoService().doGenerate((Template)null, inputModel, null, true, new BasicMonitor());
			fail(FAIL_EXPECTED_NPE);
		} catch (NullPointerException e) {
			// expected behavior
		}
	...
	public void testDoGenerateTemplatePreview() {
		final Map<String, Writer> preview = new AcceleoService().doGenerate(publicTemplate, inputModel, null,
				true, null);
		assertNotNull("A preview should have been generated by the service", preview);
		assertFalse("The preview shouldn't be empty", preview.isEmpty());
	...
	public void testDoGenerateTemplatePrivateTemplate() {
		try {
			new AcceleoService().doGenerate(privateTemplate, inputModel, null, true, new BasicMonitor());
			fail(FAIL_EXPECTED_AEE);
		} catch (AcceleoEvaluationException e) {
			// expected behavior
		}

 ...
 */
/**
 * Tests the behavior of the {@link MtlAdapterFactory generated adapter factory} for package mtl.
 *
 * @generated
 */
public class MtlAdapterFactoryTest extends TestCase {
	...
	public void testCreateModuleAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createModule()));
	}
	...
	public void testCreateModuleElementAdapter() {
		...
		assertNull(adapterFactory.createAdapter(new org.eclipse.acceleo.model.mtl.impl.ModuleElementImpl(){}));
	}
	...
	public void testCreateTemplateExpressionAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createTemplateExpression()));
	}
	...
	public void testCreateBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createBlock()));
	}
	...
	public void testCreateInitSectionAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createInitSection()));
	}
	...
	public void testCreateTemplateAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createTemplate()));
	}

	/**
	 * Ensures that creating adapters for {@link TemplateInvocation} can be done through the AdapterFactory.
	 *
	 * @generated
	 */
	public void testCreateTemplateInvocationAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createTemplateInvocation()));
	}
	...
	public void testCreateQueryAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createQuery()));
	}

	/**
	 * Ensures that creating adapters for {@link QueryInvocation} can be done through the AdapterFactory.
	 *
	 * @generated
	 */
	public void testCreateQueryInvocationAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createQueryInvocation()));
	}
	...
	public void testCreateProtectedAreaBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createProtectedAreaBlock()));
	}
	...
	public void testCreateForBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createForBlock()));
	}
	...
	public void testCreateIfBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createIfBlock()));
	}
	...
	public void testCreateLetBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createLetBlock()));
	}
	...
	public void testCreateFileBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createFileBlock()));
	}
	...
	public void testCreateTraceBlockAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createTraceBlock()));
	}
	...
	public void testCreateMacroAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createMacro()));
	}

	/**
	 * Ensures that creating adapters for {@link MacroInvocation} can be done through the AdapterFactory.
	 *
	 * @generated
	 */
	public void testCreateMacroInvocationAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createMacroInvocation()));
	}
	...
	public void testCreateTypedModelAdapter() {
		...
		assertNull(adapterFactory.createAdapter(MtlFactory.eINSTANCE.createTypedModel()));
	}
	...
	public void testIsFactoryForType() {
		MtlAdapterFactory adapterFactory = new MtlAdapterFactory();
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createModule()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createTemplateExpression()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createInitSection()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createTemplate()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createTemplateInvocation()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createQuery()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createQueryInvocation()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createProtectedAreaBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createForBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createIfBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createLetBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createFileBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createTraceBlock()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createMacro()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createMacroInvocation()));
		assertTrue(adapterFactory.isFactoryForType(MtlFactory.eINSTANCE.createTypedModel()));

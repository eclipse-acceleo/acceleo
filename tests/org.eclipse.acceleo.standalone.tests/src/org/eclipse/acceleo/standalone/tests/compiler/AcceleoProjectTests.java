...
public class AcceleoProjectTests {
	...
	public void testGetAllAcceleoModules() {
		...
		assertThat(moduleNames, hasItems("main.mtl", "genInterface.mtl", "genClassifier.mtl", "genClass.mtl", "services.mtl"));
	}
	...
	public void testGetPackageName() {
		...
		File genClassifier = new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/file/genClassifier.mtl");
		File genInterface = new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/file/genInterface.mtl");
		File services = new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/common/services.mtl");
	...
	public void testGetOutputFile() {
		...
		assertThat(outputMainFile, is(new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/main/main.emtl")));
		
		File outputGenClassFile = firstProject.getOutputFile(genClass);
		assertThat(outputGenClassFile, is(new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/file/genClass.emtl")));
		
		File outputGenClassifierFile = firstProject.getOutputFile(genClassifier);
		assertThat(outputGenClassifierFile, is(new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/file/genClassifier.emtl")));
		
		File outputGenInterfaceFile = firstProject.getOutputFile(genInterface);
		assertThat(outputGenInterfaceFile, is(new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/file/genInterface.emtl")));
		
		File outputServicesFile = firstProject.getOutputFile(services);
		assertThat(outputServicesFile, is(new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/common/services.emtl")));
	}
	...
	public void testGetInputFile() {
		...
		File genClassifier = new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/file/genClassifier.emtl");
		File genInterface = new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/file/genInterface.emtl");
		File services = new File(firstProjectRoot, "bin/org/eclipse/acceleo/project/first/common/services.emtl");
		
		File inputMainFile = firstProject.getInputFile(main);
		assertThat(inputMainFile, is(new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/main/main.mtl")));
		
		File inputGenClassFile = firstProject.getInputFile(genClass);
		assertThat(inputGenClassFile, is(new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/file/genClass.mtl")));
		
		File inputGenClassifierFile = firstProject.getInputFile(genClassifier);
		assertThat(inputGenClassifierFile, is(new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/file/genClassifier.mtl")));
		
		File inputGenInterfaceFile = firstProject.getInputFile(genInterface);
		assertThat(inputGenInterfaceFile, is(new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/file/genInterface.mtl")));
		
		File inputServicesFile = firstProject.getInputFile(services);
		assertThat(inputServicesFile, is(new File(firstProjectRoot, "src/org/eclipse/acceleo/project/first/common/services.mtl")));
	}
	
	@Test
	public void testGetChildren() {
		Set<File> children = AcceleoProject.getChildren(firstProjectRoot, IAcceleoConstants.MTL_FILE_EXTENSION);
	...
	public void testGetModuleQualifiedName() {
		...
		assertThat(firstProject.getModuleQualifiedName(main), is("org::eclipse::acceleo::project::first::main::main"));
		assertThat(firstProject.getModuleQualifiedName(genClass), is("org::eclipse::acceleo::project::first::file::genClass"));
		assertThat(firstProject.getModuleQualifiedName(genClassifier), is("org::eclipse::acceleo::project::first::file::genClassifier"));
		assertThat(firstProject.getModuleQualifiedName(genInterface), is("org::eclipse::acceleo::project::first::file::genInterface"));
		assertThat(firstProject.getModuleQualifiedName(services), is("org::eclipse::acceleo::project::first::common::services"));
	}
	
	@Test
	public void testGetFileDependency() {
		File attributes = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/attributes.mtl");
		File behavior = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/behavior.mtl");
		File common = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/common.mtl");
		File declaration = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/declaration.mtl");
		File imports = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/imports.mtl");
		File operations = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/operations.mtl");
		File properties = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/properties.mtl");
		File type = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/common/type.mtl");
		
		File classFile = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/files/classFile.mtl");
		File commonFile = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/files/commonFile.mtl");
		File enumerationFile = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/files/enumerationFile.mtl");
		File interfaceFile = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/files/interfaceFile.mtl");
		
		File workflow = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/main/workflow.mtl");
		
		File request = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/request/request.mtl");
		
		File commonServices = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/services/commonServices.mtl");
		File logger = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/services/logger.mtl");
		
		File validator = new File(fifthProjectRoot, "src/main/java/org/eclipse/acceleo/project/fifth/validator/validator.mtl");
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::attributes"), is(attributes));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::behavior"), is(behavior));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::common"), is(common));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::declaration"), is(declaration));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::imports"), is(imports));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::operations"), is(operations));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::properties"), is(properties));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::common::type"), is(type));
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::files::classFile"), is(classFile));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::files::commonFile"), is(commonFile));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::files::enumerationFile"), is(enumerationFile));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::files::interfaceFile"), is(interfaceFile));
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::main::workflow"), is(workflow));
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::request::request"), is(request));
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::services::commonServices"), is(commonServices));
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::services::logger"), is(logger));
		
		assertThat(fifthProject.getFileDependency("org::eclipse::acceleo::project::fifth::validator::validator"), is(validator));
	}
	...
	public void testGetFilesDependingOn() {
		...
		assertThat(filesDependingOnCommon, hasItems(attributes, behavior, declaration, imports, operations, type, classFile,
				commonFile, enumerationFile, interfaceFile));
		...
		assertThat(filesDependingOnDeclaration, hasItems(attributes, behavior, operations, classFile, enumerationFile,
				interfaceFile));
		...
		assertThat(filesDependingOnType, hasItems(attributes, behavior, declaration, imports, classFile, interfaceFile));
		...
		assertThat(filesDependingOnCommonServices, hasItems(common, declaration, imports, classFile, commonFile));

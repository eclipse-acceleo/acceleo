...
public class CrossReferencerService {
	...
	public Collection<EObject> eInverse(EClass target, String classifier) {
		return internalEInverse(target, classifier);
	}
	
	public Collection<EObject> eInverse(EClassifier target, String classifier) {
		return internalEInverse(target, classifier);
	}
	
	private Collection<EObject> internalEInverse(EObject target, String classifier) {
		EClassifier filter;
